...
describe("FeatureFlagService", () => {
    ...
    beforeEach(() => {
        ...
        FeatureFlagService.instance = undefined;
    ...
    describe("Flag Checking", () => {
        ...
        it("should check flag for specific user with consistent assignment", () => {
            ...
            const secondCheck = service.isEnabledForUser("fifty-percent-flag", userId);
    ...
    describe("Persistence", () => {
        it("should save flags to file", () => {
            ...
            expect(parsed.flags.find((f) => f.name === "persist-flag")).toBeDefined();
        });
    });
    ...
    describe("Business Search Enhancement Integration", () => {
        it("should properly configure business search flag", () => {
            ...
            expect(flag?.metadata?.dependencies).toContain("BusinessSearchPromptEnhancer");
        });
        it("should allow dynamic adjustment of business search rollout", () => {
            ...
            expect(service.getUserPercentage("business-search-enhancement")).toBe(100);
        });
    });
});
