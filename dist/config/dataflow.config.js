...
export const defaultDataFlowConfig = {
 ...
 */
export function getDataFlowConfig(env) {
 ...
 */
export function validateDataFlowConfig(config) {
    const errors = [];
...
//# sourceMappingURL=dataflow.config.js.map