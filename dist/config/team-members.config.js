...
export function getTeamMembersByTeam(team) {
    return TEAM_MEMBERS.filter(member => member.teams.some(t => t.toLowerCase() === team.toLowerCase()));
}
...
export const EMAIL_ALIAS_TEAMS = {
...
export function getSuggestedAssignees(emailAlias) {
...
//# sourceMappingURL=team-members.config.js.map