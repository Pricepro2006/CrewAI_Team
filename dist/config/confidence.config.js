 ...
 */
export const defaultConfidenceConfig = {
    retrieval: {
 ...
 */
export const performanceOptimizedConfig = {
    retrieval: {
 ...
 */
export const highAccuracyConfig = {
    retrieval: {
 ...
 */
export function mergeConfidenceConfigs(base, override) {
    return {
        retrieval: {
            ...base.retrieval,
            ...(override.retrieval || {}),
...
export function validateConfidenceConfig(config) {
    ...
    if (config.overall.low > config.overall.medium ||
 ...
 */
export function getConfidenceConfigFromEnv() {
    const config = {};
 ...
 */
export function getConfidenceConfig(queryType, customOverride) {
...
//# sourceMappingURL=confidence.config.js.map