...
describe("ResearchAgent", () => {
    ...
    describe("execute", () => {
        ...
        it("should handle research errors gracefully", async () => {
            ...
            vi.spyOn(mockWebSearch, "execute").mockRejectedValue(new Error("Search failed"));
            const result = await agent.execute(task.input.query, {
                task: task.input.query,
                ragDocuments: [],
            });
    ...
    describe("error handling", () => {
        ...
        it("should handle tool failures", async () => {
            ...
            vi.spyOn(mockWebSearch, "execute").mockRejectedValue(new Error("Network error"));
            vi.spyOn(mockWebScraper, "execute").mockRejectedValue(new Error("Scraping failed"));
            const result = await agent.execute(task.input.query, {
                task: task.input.query,
                ragDocuments: [],
            });
...
//# sourceMappingURL=ResearchAgent.test.js.map