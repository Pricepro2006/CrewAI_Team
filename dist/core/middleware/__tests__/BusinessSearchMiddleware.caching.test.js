...
describe("BusinessSearchMiddleware - Caching Integration", () => {
    ...
    describe("Cache Hit Scenarios", () => {
        ...
        it("should emit cache_hit event", async () => {
            ...
            // Second request should hit cache
            await wrappedProvider.generate(query);
            expect(cacheHitHandler).toHaveBeenCalledWith(expect.objectContaining({
                prompt: query,
                location: "90210",
    ...
    describe("Cache Performance", () => {
        it("should significantly reduce latency for cached responses", async () => {
            ...
            mockProvider.generate.mockImplementation(() => new Promise((resolve) => setTimeout(() => resolve("Response"), 100)));
            // First request - slow
    ...
    describe("Cache Management", () => {
        ...
        it("should preload common queries", async () => {
            ...
            const response1 = await wrappedProvider.generate("Find emergency plumber");
    ...
    describe("Cache with Validation", () => {
        it("should only cache valid responses", async () => {
            ...
            const validator = middleware.responseValidator;
            ...
            mockProvider.generate.mockResolvedValueOnce("Invalid response without contact info");
            await wrappedProvider.generate("Find services near me");
            // Second request - valid response, should cache
            mockProvider.generate.mockResolvedValueOnce("Valid: Call 555-1234 at 123 Main St");
    ...
    describe("Cache with Rate Limiting", () => {
        it("should not cache rate-limited requests", async () => {
            ...
            await wrappedProvider.generate(query);
            // Reset rate limit
            vi.spyOn(middleware, "checkRateLimit").mockResolvedValue(true);
...
//# sourceMappingURL=BusinessSearchMiddleware.caching.test.js.map