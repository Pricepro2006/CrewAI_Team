...
export class LocationDatabase {
    ...
    static getStateAbbreviation(state) {
        ...
        const stateInfo = this.STATE_INFO.find(s => s.name.toLowerCase() === lowerState ||
     ...
     */
    static getMajorCities(state) {
        const stateInfo = this.STATE_INFO.find(s => s.name.toLowerCase() === state.toLowerCase() ||
     ...
     */
    static getRegionalTerms(region, service) {
        const regionalTerms = this.SERVICE_TERMINOLOGY.find(t => t.region.toLowerCase() === region.toLowerCase());
     ...
     * Get city metadata
     */
    static getCityMetadata(city) {
        const cityInfo = this.CITY_CORRECTIONS.find(c => c.correct.toLowerCase() === city.toLowerCase() ||
