...
export class CachedMasterOrchestrator extends MasterOrchestrator {
    ...
    cachedPerfMonitor = createPerformanceMonitor("CachedMasterOrchestrator");
    constructor(config) {
        super(config);
    ...
    async shutdown() {
        ...
        if (this.cleanup) {
            shutdownPromises.push(this.cleanup());
        }
        try {
     ...
     */
    calculateCacheTTL(query, result) {
...
export function createCachedOrchestrator(config) {
...
//# sourceMappingURL=CachedMasterOrchestrator.js.map