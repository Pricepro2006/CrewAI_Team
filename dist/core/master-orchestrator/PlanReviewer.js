...
export class PlanReviewer {
    ...
    async reviewPlan(plan) {
        ...
        const hasUndefinedDependencies = plan.steps.some(step => step.dependencies?.some(dep => !plan.steps.find(s => s.id === dep)));
    ...
    async reviewExecution(plan, executionResult) {
...
//# sourceMappingURL=PlanReviewer.js.map