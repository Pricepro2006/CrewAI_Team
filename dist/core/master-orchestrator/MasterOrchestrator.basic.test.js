...
describe("MasterOrchestrator Basic Tests", () => {
    ...
    beforeAll(async () => {
        ...
        if (!isOllamaAvailable) {
            console.log("Ollama not running - tests will fail gracefully per guardrails");
        }
    });
    beforeEach(async () => {
    ...
    describe("Plan Creation", () => {
        it("should create a plan structure with real LLM", async () => {
            ...
            const plan = await Promise.race([
                ...
                new Promise((_, reject) => setTimeout(() => reject(new Error("Plan creation timeout")), 10000)),
            ]);
...
//# sourceMappingURL=MasterOrchestrator.basic.test.js.map