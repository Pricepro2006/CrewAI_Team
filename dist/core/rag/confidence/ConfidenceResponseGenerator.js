...
import { GenerationRequest, GenerationResult, GenerationOptions, TokenConfidence } from './types.js';
export class ConfidenceResponseGenerator {
     ...
     */
    async generateWithConfidence(request) {
     ...
     */
    buildConfidencePrompt(request, options) {
        const sections = [];
        // Add system context
     ...
     */
    extractTokenConfidence(response) {
     ...
     */
    calculateRawConfidence(tokenConfidence) {
     ...
     */
    identifyUncertaintyAreas(response, request) {
        const areas = [];
     ...
     */
    generateReasoning(request, response, confidence) {
        const factors = [];
        // Context quality
     ...
     */
    async generateStreamingWithConfidence(request, onToken) {
