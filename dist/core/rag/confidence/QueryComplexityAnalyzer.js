...
export class QueryComplexityAnalyzer {
     ...
     */
    calculateSyntacticComplexity(query) {
     ...
     */
    calculateSemanticComplexity(query) {
     ...
     */
    calculateDomainSpecificity(query) {
        const lowerQuery = query.toLowerCase();
        let score = 0;
    ...
    calculateOverallScore(factors) {
        ...
        const score = factors.syntacticComplexity * weights.syntacticComplexity +
