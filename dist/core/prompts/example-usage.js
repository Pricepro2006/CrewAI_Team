...
export class BusinessSearchAgent {
    promptEnhancer = businessSearchPromptEnhancer;
    ollama;
    constructor() {
    ...
    determineEnhancementLevel(query) {
    ...
    parseBusinessResponse(response) {
...
export async function dynamicEnhancementExample(userQuery) {
    try {
