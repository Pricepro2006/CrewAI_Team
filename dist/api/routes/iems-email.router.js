...
export const iemsEmailRouter = router({
    ...
    getCategorizedEmails: publicProcedure
        ...
        try {
            ...
            logger.error("Failed to get categorized emails", "IEMS_ROUTER", error);
    ...
    updateEmailStatus: publicProcedure
        ...
        try {
            ...
            logger.error("Failed to update email status", "IEMS_ROUTER", error);
    ...
    assignEmail: publicProcedure
        ...
        try {
            ...
            logger.error("Failed to assign email", "IEMS_ROUTER", error);
    ...
    performEmailAction: publicProcedure
        ...
        try {
            ...
            logger.error("Failed to perform email action", "IEMS_ROUTER", error);
    ...
    getEmailSummary: publicProcedure
        ...
        try {
            ...
            logger.error("Failed to get email summary", "IEMS_ROUTER", error);
    ...
    getTeamMembers: publicProcedure.query(async () => {
        try {
            ...
            logger.error("Failed to get team members", "IEMS_ROUTER", error);
    ...
    getAnalytics: publicProcedure.query(async () => {
        try {
            ...
            logger.error("Failed to get analytics", "IEMS_ROUTER", error);
            throw new Error("Failed to retrieve analytics");
        }
    }),
});
//# sourceMappingURL=iems-email.router.js.map