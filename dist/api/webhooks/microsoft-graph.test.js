...
describe('Microsoft Graph Webhook Handler', () => {
    ...
    describe('Subscription Validation', () => {
        it('should respond with validation token when provided', async () => {
            ...
            await graphWebhookHandler(mockRequest, mockResponse);
                ...
                value: [
                    {
                        ...
                        changeType: 'created',
                        resource: '/users/user@tdsynnex.com/mailFolders/inbox/messages/msg-123',
                        resourceData: {
                ...
                value: [
                    {
                        ...
                        subscriptionId: 'sub-123',
                        changeType: 'created',
                        resource: '/users/user1@tdsynnex.com/mailFolders/inbox/messages/msg-1',
                        clientState: process.env.WEBHOOK_CLIENT_STATE || 'SecretClientState',
                        tenantId: 'tenant-123'
                    },
                    {
                        ...
                        subscriptionId: 'sub-123',
                        changeType: 'updated',
                        resource: '/users/user2@tdsynnex.com/mailFolders/inbox/messages/msg-2',
                        clientState: process.env.WEBHOOK_CLIENT_STATE || 'SecretClientState',
                        tenantId: 'tenant-123'
                    },
                    {
                        ...
                        subscriptionId: 'sub-123',
                        changeType: 'created',
                        resource: '/users/user3@tdsynnex.com/mailFolders/inbox/messages/msg-3',
                        clientState: process.env.WEBHOOK_CLIENT_STATE || 'SecretClientState',
                        tenantId: 'tenant-123'
                    }
                ]
                ...
                value: [
                    {
                        ...
                        subscriptionId: 'sub-123',
                        changeType: 'created',
                        resource: '/users/user@tdsynnex.com/mailFolders/inbox/messages/msg-new',
                        clientState: process.env.WEBHOOK_CLIENT_STATE || 'SecretClientState',
                        tenantId: 'tenant-123'
                    }
                ]
                ...
                value: [
                    {
                        ...
                        subscriptionId: 'sub-123',
                        changeType: 'updated',
                        resource: '/users/user@tdsynnex.com/mailFolders/inbox/messages/msg-updated',
                        clientState: process.env.WEBHOOK_CLIENT_STATE || 'SecretClientState',
                        tenantId: 'tenant-123'
                    }
                ]
...
//# sourceMappingURL=microsoft-graph.test.js.map