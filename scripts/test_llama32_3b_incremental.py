#!/usr/bin/env python3
"""
Test Llama 3.2:3b model on test emails with incremental saving
"""
...
def analyze_email_with_llama32(email_data):
...
Respond ONLY with valid JSON, no additional text."""
    ...
    try:
        response = requests.post(
            ...
            timeout=60  # 1 minute timeout per email
        )
...
def main():
    ...
    results = []
    if os.path.exists('llama32_3b_results_incremental.json'):
    ...
    for i, email_id in enumerate(test_email_ids):
        ...
        if row:
            ...
            # Analyze email
            analysis = analyze_email_with_llama32(email_data)
            ...
            with open('llama32_3b_results_incremental.json', 'w') as f:
    ...
    print("\n" + "="*50)
    print("Llama 3.2:3b Test Summary")
    print("="*50)
    ...
    with open('llama32_3b_summary.csv', 'w') as f:
    ...
    print(f"\nResults saved to: llama32_3b_results_incremental.json")
    print(f"Summary saved to: llama32_3b_summary.csv")
