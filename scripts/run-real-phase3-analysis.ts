...
async function processTestBatches() {
  console.log(
    "🚀 REAL Phase 3 Analysis with Actual doomgrave/phi-4 LLM Calls\n",
  );
  ...
  console.log(
    `🔬 Processing first ${emailsToProcess.length} emails as demonstration...\n`,
  );
  ...
  console.log(
    `Average time per email: ${(totalProcessingTime / successCount / 1000).toFixed(1)}s`,
  );
  console.log(
