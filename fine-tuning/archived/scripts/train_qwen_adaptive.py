#!/usr/bin/env python3
"""
Adaptive Training Pipeline for Qwen2.5-1.5B-Instruct
...
@dataclass
class QwenConfig:
    """Configuration optimized for Qwen2.5-1.5B on CPU"""
    
    # Model configuration
    model_name: str = "Qwen/Qwen2.5-1.5B-Instruct"  # 1.5B params, no auth needed
    model_revision: str = "main"
    trust_remote_code: bool = True
    
    # Paths
    dataset_dir: str = "./datasets/gemma_formatted"  # Using same formatted data
    output_dir: str = "./qwen-1.5b-finetuned"
    checkpoint_dir: str = "./checkpoints-qwen"
...
class AdaptiveQwenTrainer:
    """Main trainer class for Qwen2.5-1.5B with adaptive curriculum"""
    ...
    def train(self):
        ...
        logger.info("="*80)
        logger.info("QWEN2.5-1.5B ADAPTIVE TRAINING PIPELINE")
...
def main():
    ...
    # Create trainer
    trainer = AdaptiveQwenTrainer(config)
