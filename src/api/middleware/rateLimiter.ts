...
export const agentRateLimiter = createRateLimiter({
  ...
  message: 'Too many agent execution requests. Please wait before submitting more tasks.'
});
...
export const fileOperationRateLimiter = createRateLimiter({
  ...
  message: 'Too many file operations. Please wait before performing more file actions.'
});
...
export const authRateLimiter = createRateLimiter({
  ...
  handler: (req: Request, res: Response) => {
    ...
    res.status(429).json({
      ...
      message: 'Too many failed authentication attempts. Your account has been temporarily locked.',
