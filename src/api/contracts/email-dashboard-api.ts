...
export type BulkUpdateEmailsRequest = z.infer<
  typeof BulkUpdateEmailsRequestSchema
>;

// Export emails request
export const ExportEmailsRequestSchema = z.object({
  format: ExportFormatEnum,
  filters: ListEmailsRequestSchema.omit({
    page: true,
    pageSize: true,
  }).optional(),
...
export type GetFilterOptionsResponse = z.infer<
  typeof GetFilterOptionsResponseSchema
>;
...
export type CreateFilterPresetRequest = z.infer<
  typeof CreateFilterPresetRequestSchema
>;
