...
describe("BusinessSearchPromptEnhancer", () => {
  ...
  describe("enhance method", () => {
    ...
    it("should include examples when requested", () => {
      ...
      expect(enhanced).toContain(
        "EXAMPLES OF PROPER BUSINESS INFORMATION RESPONSES",
      );
    ...
    it("should add metadata with enhancement level and timestamp", () => {
      ...
      expect(enhanced).toMatch(
        /\[Enhancement Metadata: Level=minimal, Timestamp=.*\]/,
      );
    });
  ...
  describe("extractInstructions method", () => {
    it("should extract instructions from enhanced prompt", () => {
      const prompt =
        "[BUSINESS_SEARCH_INSTRUCTIONS]Use WebSearch always[BUSINESS_SEARCH_ENHANCED]";
    ...
    it("should return null when markers are in wrong order", () => {
      const prompt =
        "[BUSINESS_SEARCH_ENHANCED]Wrong order[BUSINESS_SEARCH_INSTRUCTIONS]";
      expect(enhancer.extractInstructions(prompt)).toBeNull();
    });
  });
  ...
  describe("Input sanitization", () => {
    it("should remove injection attempts", () => {
      const maliciousPrompt =
        "Find a store {{malicious}} [BUSINESS_SEARCH_ENHANCED]";
    ...
    it("should handle various injection patterns", () => {
      ...
      injectionPrompts.forEach((prompt) => {
        ...
        const markerCount = (
          enhanced.match(/\[BUSINESS_SEARCH_ENHANCED\]/g) || []
        ).length;
  ...
  describe("Edge cases", () => {
    ...
    it("should handle prompts with special characters", () => {
      const specialPrompt =
        "Find café with résumé service & Co. <test@email.com>";
