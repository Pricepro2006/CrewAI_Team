...
import { BusinessSearchPromptEnhancer, BusinessSearchEnhancementOptions } from '../BusinessSearchPromptEnhancer';
...
describe('BusinessSearchPromptEnhancer', () => {
  let enhancer: BusinessSearchPromptEnhancer;
  ...
  describe('enhance method', () => {
    ...
    it('should apply minimal enhancement level', () => {
      const enhanced = enhancer.enhance('Find a store', { enhancementLevel: 'minimal' });
    ...
    it('should apply aggressive enhancement level', () => {
      const enhanced = enhancer.enhance('Find a store', { enhancementLevel: 'aggressive' });
    ...
    it('should include examples when requested', () => {
      const enhanced = enhancer.enhance('Find a store', { includeExamples: true });
    ...
    it('should not include examples when disabled', () => {
      const enhanced = enhancer.enhance('Find a store', { includeExamples: false });
    ...
    it('should preserve original markers when requested', () => {
      ...
      const enhanced = enhancer.enhance(alreadyEnhanced, { preserveOriginalMarkers: true });
    ...
    it('should replace markers when not preserving', () => {
      const alreadyEnhanced = 'Some prompt [BUSINESS_SEARCH_ENHANCED]';
      const enhanced = enhancer.enhance(alreadyEnhanced, { preserveOriginalMarkers: false });
    ...
    it('should handle error during enhancement', () => {
      ...
      const badOptions: any = { enhancementLevel: null };
