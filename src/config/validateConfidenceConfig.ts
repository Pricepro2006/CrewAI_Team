...
export function runConfidenceConfigValidation(): void {
  ...
  console.log(
    `   - Retrieval: min=${defaultConfig.retrieval.minimum}, preferred=${defaultConfig.retrieval.preferred}`,
  );
  console.log(
    `   - Generation: acceptable=${defaultConfig.generation.acceptable}, review=${defaultConfig.generation.review}`,
  );
  console.log(
    `   - Overall: high=${defaultConfig.overall.high}, medium=${defaultConfig.overall.medium}, low=${defaultConfig.overall.low}\n`,
  );
  ...
  console.log(
    `   - Retrieval min overridden to: ${envConfig.retrieval.minimum}`,
  );
