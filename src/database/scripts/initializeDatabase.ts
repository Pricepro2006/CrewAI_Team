...
const sampleData: SampleData = {
  ...
  dealItems: [
    ...
    {
      deal_id: "45791720",
      product_number: "7ED25UT",
      product_family: "IPG",
      remaining_quantity: 150,
      dealer_net_price: 125.99,
      description: "Enterprise Storage Unit",
    },
    {
      deal_id: "45791720",
      product_number: "9VD15AA",
      product_family: "PSG",
      remaining_quantity: 75,
      dealer_net_price: 89.5,
      description: "Network Switch",
    },
    {
      deal_id: "45791720",
      product_number: "4XDJ3UT#ABA",
      product_family: "IPG",
      remaining_quantity: 200,
      dealer_net_price: 45.75,
    ...
    {
      deal_id: "44892156",
      product_number: "2XHJ8UT",
      product_family: "PSG",
      remaining_quantity: 100,
      dealer_net_price: 299.99,
      description: "Server Blade",
    },
    {
      deal_id: "44892156",
      product_number: "5TW10AA",
      product_family: "IPG",
      remaining_quantity: 50,
      dealer_net_price: 189.0,
    ...
    {
      deal_id: "46123789",
      product_number: "8QR45CV",
      product_family: "IPG",
      remaining_quantity: 300,
      dealer_net_price: 67.25,
      description: "Storage Drive",
    },
    {
      deal_id: "46123789",
      product_number: "1ZX23MN",
      product_family: "PSG",
      remaining_quantity: 25,
      dealer_net_price: 1250.0,
    ...
    {
      deal_id: "47845321",
      product_number: "3QW67RT",
      product_family: "IPG",
      remaining_quantity: 80,
      dealer_net_price: 450.0,
      description: "Server Processor",
    },
    {
      deal_id: "47845321",
      product_number: "6YU89OP",
      product_family: "PSG",
      remaining_quantity: 120,
      dealer_net_price: 180.75,
  ...
  emails: [
    {
      ...
      body_text:
        "Hi, we need an urgent quote for the items in deal 45791720. The quantities we need are: 7ED25UT x50, 9VD15AA x25. Please provide pricing and availability ASAP.",
      priority: "critical",
      status: "new",
    },
    {
      ...
      body_text:
        "Please confirm the order details for PO# PO123456. We need confirmation for part 2XHJ8UT quantity 50 from deal 44892156.",
      priority: "high",
      status: "in_progress",
    },
    {
      ...
      body_text:
        "Can you provide shipping status for case# CS789012? This is regarding the order for part 8QR45CV from our recent deal.",
      priority: "medium",
      status: "new",
    },
    {
      ...
      body_text:
        "We would like to request an extension for deal 47845321. Can we extend the end date by 3 months? We are still evaluating the 3QW67RT processors.",
      priority: "medium",
      status: "completed",
    },
  ],
...
if (require.main === module) {
  ...
  switch (command) {
    ...
    default:
      logger.error(
        `Unknown command: ${command}. Use 'init' or 'reset'`,
        "DB_INIT",
      );
      process.exit(1);
  }
