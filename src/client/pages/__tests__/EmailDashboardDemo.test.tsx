    ...
    <div data-testid="email-dashboard-multi-panel">
      ...
      {emails.map((email: any) => (
        <div key={email.id} data-testid={`email-${email.id}`}>
          ...
          <button onClick={() => onAssignEmail(email.id, "john-smith")}>
            Assign
          </button>
...
describe("EmailDashboardDemo Component", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render email dashboard multi-panel", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByTestId("email-dashboard-multi-panel"),
        ).toBeInTheDocument();
      });
    });
  });
  ...
  describe("Success Messages", () => {
    it("should show success message after successful email assignment", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Email assigned successfully!"),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should show success message after successful status update", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Email status updated successfully!"),
        ).toBeInTheDocument();
      });
    });
    ...
    it("should show success message after manual refresh", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Data refreshed successfully!"),
        ).toBeInTheDocument();
      });
    });
  });
