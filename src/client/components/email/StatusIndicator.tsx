...
const statusConfig: Record<EmailStatus, { color: string; bgColor: string; label: string }> = {
  red: {
    color: 'bg-red-500',
    bgColor: 'bg-red-100',
    label: 'Critical',
...
export function StatusIndicator({
  ...
  const indicator = (
    <div className={cn('flex items-center', sizeStyles.gap, className)}>
      <div className={cn('relative flex items-center justify-center', sizeStyles.container)}>
