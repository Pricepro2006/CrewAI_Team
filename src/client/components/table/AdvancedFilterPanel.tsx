...
export const AdvancedFilterPanel: React.FC<AdvancedFilterPanelProps> = ({
  ...
  const getOperatorOptions = useCallback((columnType: string) => {
    ...
    return [...baseOperators, { value: "regex", label: "Regex pattern" }];
  }, []);
  ...
  return (
    <div
      className={`advanced-filter-panel bg-white border border-gray-200 rounded-lg shadow-sm ${className}`}
    >
      {/* Header */}
