...
export const Dashboard: React.FC = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M16 21V19C16 17.9391 15.5786 16.9217 14.8284 16.1716C14.0783 15.4214 13.0609 15 12 15H6C4.93913 15 3.92172 15.4214 3.17157 16.1716C2.42143 16.9217 2 17.9391 2 19V21M12.5 7C12.5 9.48528 10.4853 11.5 8 11.5C5.51472 11.5 3.5 9.48528 3.5 7C3.5 4.51472 5.51472 2.5 8 2.5C10.4853 2.5 12.5 4.51472 12.5 7ZM20.5 8.5V11.5M22 10H19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M21 16V8C20.9996 7.64928 20.9071 7.30481 20.7315 7.00116C20.556 6.69751 20.3037 6.44536 20 6.267L13 2.267C12.696 2.08837 12.3511 1.99591 12 1.99591C11.6489 1.99591 11.304 2.08837 11 2.267L4 6.267C3.69626 6.44536 3.44398 6.69751 3.26846 7.00116C3.09294 7.30481 3.00036 7.64928 3 8V16C3.00036 16.3507 3.09294 16.6952 3.26846 16.9988C3.44398 17.3025 3.69626 17.5546 4 17.733L11 21.733C11.304 21.9116 11.6489 22.0041 12 22.0041C12.3511 22.0041 12.696 21.9116 13 21.733L20 17.733C20.3037 17.5546 20.556 17.3025 20.7315 16.9988C20.9071 16.6952 20.9996 16.3507 21 16Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  ...
  const availableAgents = [
    { name: "Research Agent", status: 'active' as const, specialty: "Information Gathering" },
    { name: "Code Agent", status: 'idle' as const, specialty: "Code Generation" },
    { name: "Data Analysis Agent", status: 'busy' as const, specialty: "Data Processing" },
      ...
      <div className="dashboard-content">
        ...
        <div className="dashboard-sections">
          <div className="ollama-status-section">
            <h2>Ollama Status</h2>
            <div className={`ollama-status ${isOllamaConnected ? 'connected' : 'offline'}`}>
