...
export const SecurityStatusMonitor: React.FC = () => {
  ...
  const getOverallStatus = () => {
    const checks = [
      ...
      Object.values(securityStatus.headers).filter(h => h !== null).length >= 3
    ];
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700">
        <button
          ...
          className={`flex items-center gap-2 px-4 py-2 rounded-lg transition-colors ${
            overallStatus === 'secure' ? 'text-green-600 dark:text-green-400' :
        ...
        {isExpanded && (
          <div className="border-t border-gray-200 dark:border-gray-700 p-4 space-y-3">
            ...
            <div className="space-y-2">
              <h3 className="font-semibold text-sm text-gray-700 dark:text-gray-300">Core Security</h3>
            ...
            {/* Security Headers */}
            <div className="space-y-2">
              <h3 className="font-semibold text-sm text-gray-700 dark:text-gray-300">Security Headers</h3>
            ...
            {csrfStatus.hasToken && (
              <div className="text-xs text-gray-500 dark:text-gray-400 border-t pt-2">
                ...
                {csrfStatus.lastRefresh && (
                  <div>Last Refresh: {csrfStatus.lastRefresh.toLocaleTimeString()}</div>
                )}
              </div>
            )}
          </div>
