...
import { useCSRFProtectedMutation, useCSRFFormSubmit } from '../../hooks/useCSRFProtectedMutation.js';
  ...
  const formSubmit = useCSRFFormSubmit({
    ...
    onError: (error) => {
      ...
      if (error.message.toLowerCase().includes('csrf')) {
        csrfErrorModal.showError(error, () => formSubmit.submit('/api/example', formData));
      } else {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="mb-6">
          <h3 className="text-lg font-semibold mb-2">Manual Token Management</h3>
          <button
        ...
        {process.env.NODE_ENV === 'development' && (
          <div className="p-4 bg-gray-50 dark:bg-gray-900 rounded-md">
            ...
            <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
              ...
              <li>• Failed requests are automatically retried with fresh tokens</li>
