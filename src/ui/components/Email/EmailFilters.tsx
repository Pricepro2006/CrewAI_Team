    ...
    <div className="email-filters">
      <div className="email-filters__header">
        ...
        {hasActiveFilters && (
          <button
            onClick={onClear}
            className="email-filters__clear-btn"
          >
      ...
      <div className="email-filters__content">
        ...
        <div className="email-filters__section">
          ...
          <select
            ...
            onChange={(e) => onFilterChange({ workflow: e.target.value || undefined })}
        ...
        <div className="email-filters__section">
          ...
          <select
            ...
            onChange={(e) => onFilterChange({ slaStatus: e.target.value || undefined })}
            className="email-filters__select"
          >
        ...
        <div className="email-filters__section">
          ...
          <div className="email-filters__date-range">
            <div className="email-filters__date-input">
              <label htmlFor="start-date" className="email-filters__date-label">From</label>
              <input
                id="start-date"
                type="date"
            ...
            <div className="email-filters__date-input">
              <label htmlFor="end-date" className="email-filters__date-label">To</label>
              <input
                id="end-date"
                type="date"
          ...
          <div className="email-filters__active-list">
            ...
            {filters.slaStatus && (
              <div className="email-filters__active-item">
                ...
                <button onClick={() => onFilterChange({ slaStatus: undefined })}>
                  <XMarkIcon className="email-filters__active-remove" />
                </button>
              </div>
            )}
            ...
            {filters.dateRange && (
              <div className="email-filters__active-item">
                <span>Date Range: {filters.dateRange.start.toLocaleDateString()} - {filters.dateRange.end.toLocaleDateString()}</span>
                <button onClick={() => onFilterChange({ dateRange: undefined })}>
                  <XMarkIcon className="email-filters__active-remove" />
                </button>
              </div>
            )}
