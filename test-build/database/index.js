...
export { DatabaseConnectionPool, getDatabaseConnection, executeQuery, executeTransaction, shutdownConnectionPool, } from "./ConnectionPool.js";
 ...
 */
export async function executeSecure(sql, params, dbPath) {
 ...
 */
export async function executeTransactionOptimized(queries, dbPath) {
    const db = getDatabase(dbPath);
 ...
 */
export function getCentralizedDatabaseStats(dbPath) {
    const db = getDatabase(dbPath);
 ...
 */
export function clearDatabaseCache(dbPath) {
    const db = getDatabase(dbPath);
    db.clearCache();
...
export { UnifiedConnectionManager, getUnifiedConnectionManager, createDefaultConfig, } from "./UnifiedConnectionManager.js";
...
export { DealRepository, DealItemRepository, ProductFamilyRepository, } from "./repositories/DealRepository.js";
