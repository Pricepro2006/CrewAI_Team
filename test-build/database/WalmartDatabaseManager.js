...
export class WalmartDatabaseManager {
    ...
    constructor(config) {
        ...
        logger.info(`Walmart Database Manager initialized with database at: ${dbPath}`, "WALMART_DB");
    }
    ...
    async seedSampleData() {
        ...
        const productCount = this?.db?.prepare("SELECT COUNT(*) as count FROM walmart_products").get();
...
export function getWalmartDatabaseManager() {
