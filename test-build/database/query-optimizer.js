 ...
 */
import { OptimizedQueryExecutor } from './OptimizedQueryExecutor.js';
import { logger } from '../utils/logger.js';
import appConfig from '../config/app.config.js';
// Singleton instance
let queryExecutorInstance = null;
/**
 * Get the singleton OptimizedQueryExecutor instance
 * Ensures all database queries share the same cache and optimizations
 */
export function getOptimizedQueryExecutor() {
 ...
 */
export async function executeOptimizedQuery(sql, params) {
